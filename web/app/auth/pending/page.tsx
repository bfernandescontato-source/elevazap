...
export default function PendingPage() {
  return <AuthShell title="Cadastro recebido" description="Seu e-mail foi confirmado. Um administrador precisa aprovar o acesso antes de você entrar no painel." footer={<BackToLogin />}>
