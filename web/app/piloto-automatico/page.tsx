...
export default function AutopilotPage() {
  ...
  const visibleOffers = data?.offers.filter((offer) => ["waiting", "scheduled", "sent"].includes(offer.status)) || [];
  const scheduledOffers = visibleOffers.filter((offer) => ["waiting", "scheduled"].includes(offer.status));
