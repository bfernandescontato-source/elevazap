...
async function list(database: Database, table: "envios" | "envios_grupo" | "envios_grupo_lotes", accountId: string, limit: number) {
...
export const listDispatchBatches = (database: Database, accountId: string) => list(database, "envios_grupo_lotes", accountId, 200);
